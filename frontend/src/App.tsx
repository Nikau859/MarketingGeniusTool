...
function App() {
  ...
  if (!payPalClientId) {
    return <div className="text-red-500 font-medium p-8 text-center">Error: PayPal Client ID is not configured. Please set the VITE_PAYPAL_CLIENT_ID environment variable.</div>;
  }
